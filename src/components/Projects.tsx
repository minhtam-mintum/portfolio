...
const projects = [
  {
    ...
    desc: "Comprehensive backoffice web application for a banking platform, enabling internal staff to manage customers, transactions, system configuration, and reporting. Owned end-to-end frontend architecture from project setup to production.",
    ...
    highlights: [
      ...
      "Core banking modules: KYC, transaction management (PayBill, AutoBill, Topup), SMS & voucher management",
  ...
  },
  {
    ...
    tags: ["React 17", "TypeScript", "Vite", "React Query", "React Hook Form", "React Router v6"],
    highlights: [
      ...
      "Marketing Center campaigns, subscription Plan & Pricing tiers, Support Center with FAQ & ticketing",
    ],
  },
  {
    category: "Enterprise" as Category,
